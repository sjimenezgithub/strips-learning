...
(and
	...
	(not (at-robot loc-x0-y2))
	(not (at-robot loc-x0-y3))
	(not (at-robot loc-x0-y4))
	(not (at-robot loc-x1-y0))
	(not (at-robot loc-x1-y1))
	(not (at-robot loc-x1-y2))
	(not (at-robot loc-x1-y3))
	(not (at-robot loc-x1-y4))
	(not (at-robot loc-x2-y0))
	(not (at-robot loc-x2-y1))
	(not (at-robot loc-x2-y3))
	(not (at-robot loc-x2-y4))
	(not (at-robot loc-x3-y0))
	(not (at-robot loc-x3-y1))
	(not (at-robot loc-x3-y2))
	(not (at-robot loc-x3-y3))
	(not (at-robot loc-x3-y4))
	(not (at-robot loc-x4-y0))
	(not (at-robot loc-x4-y1))
	(not (at-robot loc-x4-y2))
	(not (at-robot loc-x4-y3))
	(not (at-robot loc-x4-y4))
	(at-robot loc-x2-y2)
	...
	(not (visited loc-x2-y3))
	(not (visited loc-x2-y4))
	(not (visited loc-x3-y0))
	(not (visited loc-x3-y1))
	(not (visited loc-x3-y2))
	(not (visited loc-x3-y3))
	(not (visited loc-x3-y4))
	(not (visited loc-x4-y0))
	(not (visited loc-x4-y1))
	(not (visited loc-x4-y2))
	(not (visited loc-x4-y3))
	(not (visited loc-x4-y4))
