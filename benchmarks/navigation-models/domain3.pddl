(define (domain grid-navigation)    ;;; Parameters: 2-1-0-0-0-0-1-0-1
...
(:action inc_vertical_0
  ...
  :effect (and (visited ?v2 ?v) (not (ycoord ?v1)) (ycoord ?v2) (not(q0)) (q1)))

(:action inc_vertical_1
  :parameters (?v1 ?v2 ?v)
  :precondition (and (xcoord ?v) (ycoord ?v1) (next ?v1 ?v2) (q1))
  :effect (and (visited ?v2 ?v) (not (ycoord ?v1)) (ycoord ?v2) (not(q1)) (q0)))
