(define (domain grid-navigation)    ;;; Parameters: 2--3-0--3--1-0--1
...
(:action inc_horizontal
  :parameters (?v1 ?v2 ?v)
  :precondition (and (ycoord ?v) (xcoord ?v1) (next ?v1 ?v2) (max ?v))
  :effect (and (visited ?v2 ?v) (not (xcoord ?v1)) (xcoord ?v2)))

(:action dec_horizontal
  :parameters (?v1 ?v2 ?v)
  :precondition (and (ycoord ?v) (xcoord ?v1) (next ?v2 ?v1) (max ?v))
  :effect (and (visited ?v2 ?v) (not (xcoord ?v1)) (xcoord ?v2)))
