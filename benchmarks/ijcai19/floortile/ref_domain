...
(:action paint-down
  :parameters (?o1 - robot ?o2 - tile ?o3 - tile ?o4 - color)
  :precondition (and (robot-has ?o1 ?o4) (robot-at ?o1 ?o3) (down ?o2 ?o3) (clear ?o2))
  :effect (and (not (clear ?o2)) (painted ?o2 ?o4))
)

(:action up 
  :parameters (?o1 - robot ?o2 - tile ?o3 - tile)
  :precondition (and (robot-at ?o1 ?o2) (up ?o3 ?o2) (clear ?o3))
...
(:action right 
  :parameters (?o1 - robot ?o2 - tile ?o3 - tile)
  :precondition (and (robot-at ?o1 ?o2) (right ?o3 ?o2) (clear ?o3))
  :effect (and (robot-at ?o1 ?o3) (not (robot-at ?o1 ?o2))
               (clear ?o2) (not (clear ?o3)))
)
