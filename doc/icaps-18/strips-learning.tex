...
\node (initA) []{A};
\node (initB) [above=of initA.north]{B};
\node (initC) [above=of initB.north]{C};
\node (initD) [above=of initC.north]{D};

\node (goalD) [right=of initA.south east]{D};
\node (goalC) [right=of initB.south east]{C};
\node (goalB) [right=of initC.south east]{B};
\node (goalA) [right=of initD.south east]{A};
\end{tikzpicture}
