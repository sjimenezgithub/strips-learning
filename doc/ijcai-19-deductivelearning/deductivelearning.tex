...
Here we describe a pre-processing mechanism to add new literals to complete the partial states $\tup{s_1^o \ldots, s_m^o}$ of an observation using a set of {\em schematic mutex} $\Phi$.
