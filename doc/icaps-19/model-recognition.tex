...
\item $M=\{\mathcal{M}_1,\ldots,\mathcal{M}_m\}$ is a finite and non-empty {\em set of models} for the actions in $A$. Each model in $\mathcal{M}\in M$ defines a different function pair ($\rho$,$\theta$).
