...
\textcolor{blue}{Timeouts are only observed in the setting with NO action sequences and NO state trajectories. We have added a few sentences providing more details on this issue.}
...
\textcolor{blue}{We have provided better justification for the use of semantic evaluation metrics.}
