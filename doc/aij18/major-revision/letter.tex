...
\textcolor{blue}{Following the reviewer's advice, we have substantially changed section 3. We refer the reviewer to our main modification \#2. We removed the complexity table of page 8 and we now focus the discussion around the two main cases that determine the difficulty of the learning task, giving an indication of the task complexity according to the characteristics that define these two cases. We also changed the reference and added instead the original work that proves that boolean SAT problems are NP-complete.}
