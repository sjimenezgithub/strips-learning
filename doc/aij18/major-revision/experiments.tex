...
\item {\bf Planner}. The classical planner we used to solve the instances of $P_\Lambda$ that result from our compilations is {\sc Madagascar}~\cite{rintanen2014madagascar}. We used {\sc Madagascar} for several reasons:
  ...
  \item \textcolor[rgb]{1.00,0.00,0.00}{The ability of {\sc Madagascar} to deal with instances populated with dead-ends, such as our compiled problem $P_\Lambda$, is very helpful~\cite{lopez2015deterministic}.}
...
\begin{table}[hbt!]
	\begin{center}
		...
		\begin{tabular}{l|l|l|l|l|l|l||l|l||l|}
			...
			Rovers & 0.43 & 0.73 & 0.24 & 0.47 & 0.56 & 0.38 & 0.39 & 0.61& 31.13 \\ % [(u'drop', u'drop', 1, 2), (u'navigate', u'navigate', 1, 3, 2), (u'sample-soil', u'sample-soil', 1, 2, 3), (u'sample-rock', u'sample-rock', 1, 2, 3), (u'calibrate', u'calibrate', 1, 2, 3, 4), (u'take-image', u'take-image', 1, 2, 3, 4, 5), (u'communicate-soil-data', u'communicate-rock-data', 1, 2, 4, 3, 5), (u'communicate-rock-data', u'communicate-rock-data', 1, 2, 3, 5, 4), (u'communicate-image-data', u'communicate-image-data', 1, 2, 3, 4, 6, 5)]
